...
// in a page that all might call zeega.define(). The loader will indicate
...
if ( typeof zeega.define === 'function' && zeega.define.amd && zeega.define.amd.jQuery ) {
	zeega.define( "jquery", [], function () { return jQuery; } );
}
...
zeega.define("backbone", ["lodash","jquery"], (function (global) {
    return function () {
        var ret, fn;
...
zeega.define("jqueryUI", function(){});
